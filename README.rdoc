== Webistrano - Capistrano deployment the easy way (Rails 3.2.2)

This is a version of Webistrano (by Peritor, https://github.com/peritor/webistrano)
that has been upgraded to be a Rails 3.2.2 application capable of running on Ruby
versions 1.9.3 and newer.
